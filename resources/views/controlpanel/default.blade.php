                    ...
                    <div class="data-content">
                        ...
                        <div class="boxes">
                            <div class="row">
                                ...
                                <div class="col-md-3 col-xs-6">
                                    <div class="box-status">
                                        <p>{{\App\messages::count()}}</p>
                                        <img src="{{asset('images/icons/check.png')}}">
                                        <span>الرسائل الكليه</span>
                                    </div>
                                </div>
                                <div class="col-md-3 col-xs-6">
                                    <div class="box-status">
                                        <p>{{\App\messages::where('message_type','=','mobile')->count()}}</p>
                                        <img src="{{asset('images/icons/check.png')}}">
                                        <span>رسائل الموبيل</span>
                                        
                                    </div>
                                </div>
                                <div class="col-md-3 col-xs-6">
                                    <div class="box-status">
                                        <p>{{\App\messages::where('message_type','=','web')->count()}}</p>
                        ...
                        <div class="chart">
                            <img src="{{asset('images/public_images/chart.svg')}}">
                        </div>
                        <div class="last_orders">
                            <p><img src="{{asset('images/icons/chat.png')}}"><span>احدث الرسائل</span></p>
                            <div class="row">
                                @for($i = 0; $i<12; $i++)
