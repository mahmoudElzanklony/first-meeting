    ...
    */
    ...
    protected function create(array $data)
    {
        ...
        if($country->mobile_message_status == 1){
            ...
            $endpoint = "https://smssmartegypt.com/sms/api/?username=9Wl#7c1&password=1M@COB=?D=U:&sendername=First Meet&mobiles=20".intval($data['phone'])."&message=".urlencode($verify)."&Content-Type=application/json;charset=utf-8";
