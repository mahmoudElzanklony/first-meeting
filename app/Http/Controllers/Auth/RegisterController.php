    ...
    */
    ...
    protected function create(array $data)
    {
        ...
        if($country->mobile_message_status == 1){
            ...
            $endpoint = "https://smssmartegypt.com/sms/api/?username=mahmoud_elzanklony@yahoo.com&password=zanklony202017&sendername=First Meet&mobiles=20".intval($data['phone'])."&message=".urlencode($verify)."&Content-Type=application/json;charset=utf-8";
