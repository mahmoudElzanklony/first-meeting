...
class profileController extends Controller
{
    public function home() {
        ...
        $url = 'first-meeting.com/profile/default';
                        ...
                        if(auth()->check()){
                            if(auth()->user()->activation_phone_status == 1){
                                ...
                                if($sender_country == $receiver_country){
                                    ...
                                    $user->save();
                                    $endpoint = "https://smssmartegypt.com/sms/api/?username=mahmoud_elzanklony@yahoo.com&password=zanklony202017&sendername=First Meet&mobiles=20".intval(\App\User::find($receiver_id)->phone)."&message=". urlencode(request('message'))."&Content-Type=application/json;charset=utf-8";
