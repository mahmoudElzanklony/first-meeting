        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="image" itemscope itemtype="https://schema.org/Property">
                    <img itemprop="image" src="<?php echo e(asset('images/home/messages.png')); ?>">
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-xs-12">
                <div class="feature-image" itemscope itemtype="https://schema.org/Property">
                    <img itemprop="image" src="<?php echo e(asset('images/home/chat.jpg')); ?>">
                </div>
            </div>
            <div class="clear"></div>
            <div class="col-md-6 col-xs-12">
                <div class="feature-image" itemscope itemtype="https://schema.org/Property">
                    <img itemprop="image" src="<?php echo e(asset('images/home/think.jpg')); ?>">
                </div>
            </div>
            <div class="col-md-6 col-xs-12">
                <div class="feature-content" itemscope itemtype="https://schema.org/SoftwareApplication">
            ...
            <div class="col-md-6 col-xs-12">
                <div class="feature-image" itemscope itemtype="https://schema.org/Property">
                    <img itemprop="image" src="<?php echo e(asset('images/home/coins.jpg')); ?>">
                </div>
            </div>
            <div class="clear"></div>
            <div class="col-md-6 col-xs-12">
                <div class="feature-image" itemscope itemtype="https://schema.org/Property">
                    <img itemprop="image" src="<?php echo e(asset('images/home/send-mail.jpg')); ?>">
                </div>
            </div>
            <div class="col-md-6 col-xs-12">
                <div class="feature-content" itemscope itemtype="https://schema.org/SoftwareApplication">
            ...
            <div class="col-md-6 col-xs-12">
                <div class="feature-image" itemscope itemtype="https://schema.org/Property">
                    <img itemprop="image" src="<?php echo e(asset('images/home/gift.jpg')); ?>">
                </div>
            </div>
            <div class="clear"></div>
        </div>
...
<div class="statics">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4 col-xs-12">
                <div class="info">
                    <div class="space-bottom" itemscope itemtype="https://schema.org/StatisticalPopulation">
                        <img itemprop="image" src="<?php echo e(asset('images/icons/users.png')); ?>">
                    ...
                    <div itemscope itemtype="https://schema.org/StatisticalPopulation">
                        <img itemprop="image" src="<?php echo e(asset('images/icons/visitors.png')); ?>">
            ...
            <div class="col-md-4 col-xs-12">
                <div class="image" itemscope itemtype="https://schema.org/Property">
                    <img itemprop="image" src="<?php echo e(asset('images/home/statics-mockup.png')); ?>">
                </div>
            </div>
            <div class="col-md-4 col-xs-12">
                <div class="info">
                    <div class="space-bottom" itemscope itemtype="https://schema.org/StatisticalPopulation">
                        <img itemprop="image" src="<?php echo e(asset('images/icons/mobile-msg.png')); ?>">
                    ...
                    <div itemscope itemtype="https://schema.org/StatisticalPopulation">
                        <img itemprop="image" src="<?php echo e(asset('images/icons/mail.png')); ?>">
        ...
        <div class="slider">
            <ul id="feedback-slider">
                ...
                <li>
                    ...
                    <img src="<?php echo e(asset('images/home/1.jpg')); ?>">
                </li>
                <li>
                    <div class="content">
                        <span><i class="fas fa-quote-left"></i></span>
                ...
                <li>
                    ...
                    <img src="<?php echo e(asset('images/home/2.jpg')); ?>">
                </li>
                <li>
                    <div class="content">
                        <span><i class="fas fa-quote-left"></i></span>
...
<div class="contact">
    <div class="container">
        ...
        <div class="row">
                ...
                <div class="form" itemscope itemtype="https://schema.org/ContactPoint">
                    <form>
                        <div class="form-group">
                            <img class="img-icon-input-right" src="<?php echo e(asset('images/icons/mail-icon.png')); ?>">
                            <input itemprop="email" class="form-control" type="email" placeholder="البريد الالكتروني" required>
                        </div>
                        <div class="form-group">
                            <img style="top: 0px;" class="img-icon-input-right" src="<?php echo e(asset('images/icons/user-icon.png')); ?>">
                            <input itemprop="contactType" class="form-control" type="text" placeholder="عنوان الرساله" required>
                        </div>
                        <div class="form-group">
                            <img class="img-icon-input-right" src="<?php echo e(asset('images/icons/questions-icon.png')); ?>">
            ...
            <div class="col-md-6 col-xs-12">
                <div class="image" itemscope itemtype="https://schema.org/Property">
                    <img itemprop="image" src="<?php echo e(asset('images/home/call-center.jpg')); ?>">
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\first-meeting.net\resources\views/index/welcome.blade.php ENDPATH**/ ?>